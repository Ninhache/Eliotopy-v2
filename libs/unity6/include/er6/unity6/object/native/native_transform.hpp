...
inline bool GetNativeTransformManaged(const IMemoryAccessor& mem, std::uintptr_t nativeTransform, const GomOffsets& gomOff, const Offsets& off, std::uintptr_t& outManaged)
{
    return GetNativeComponentManaged(mem, nativeTransform, gomOff, off, outManaged);
}
